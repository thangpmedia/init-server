...
INIT_SH_URL="https://raw.githubusercontent.com/thangpmedia/init-server/refs/heads/main/init.sh"  # <-- added
...
function provisioning_start() {
    ...
    # --- ADDED: run init.sh as the final step ---
    provisioning_run_init_sh
